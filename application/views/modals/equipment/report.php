	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Report Lost <?= $title ?></h4>
			</div>
			<div class="modal-body">
				...
				<!-- report_loss -->
				<div class="form-group">
					<label class="control-label col-sm-4" for="report_loss_quantity">No.of Items Lost:</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
					  <textarea class="form-control" id="report_reason" placeholder="Enter a valid reason"></textarea>
					</div>
				</div>
